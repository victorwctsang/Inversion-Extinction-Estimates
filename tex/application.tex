...
\begin{figure}[ht]
    \centering
    \includesvg[inkscapelatex=false,width=\linewidth]{figures/plot-application-widths-samplesize.svg}
    \caption{Confidence interval widths plotted against sample size.}
