...
B = unique(round(pracma::logseq(2, 5000, 40)))
num.B = length(B)
...
```{r fig.width=12, fig.height=5, dev='tikz'}
options(scipen=9)
tikz("../figures/minmi-asymptotics-lower.tex")
plot(B, sample_var.theta_q$lower, log="xy",
     type="b",
     main="Sample Var vs. Delta Method (q=0.025)", col="blue",
...
plot(B, sample_var.theta_q$upper, log="xy",
     type="b",
     main="Sample Var vs. Delta Method (q=0.975)", col="blue",
...
plot(B, res.df$expctd_var.lower/res.df$sample_var.lower, col="blue",
     type="b", main="Ratio of Delta Method Estimate and Sample Variances", log="x",
