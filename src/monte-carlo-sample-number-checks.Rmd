...
start_time = Sys.time()
estimate_extinction.minmi(W, sd=fossil_dataframe$sd, K)
print(Sys.time() - start_time)
```

```{r}
start_time = Sys.time()
estimate_extinction.minmi(W, sd=fossil_dataframe$sd, K, level = 0.95)
print(Sys.time() - start_time)
```

```{r}
start_time = Sys.time()
estimate_extinction.minmi(W, sd=fossil_dataframe$sd, K, level = 0.95, B=500)
print(Sys.time() - start_time)
```
