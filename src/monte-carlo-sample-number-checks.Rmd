...
$$
\mathrm{Var}(\hat\theta_q) \longrightarrow \frac{1}{B} \sigma^2_{\psi(\theta_q)} \left[ \frac{F(K-\theta_q )\hat\psi'(\theta) + f(K-\theta_q)\hat\psi(\theta_q)}{F(K-\theta_q)} \right]^{-2}
$$
