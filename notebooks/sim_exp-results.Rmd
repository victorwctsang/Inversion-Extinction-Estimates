...
B.minmi.kbl = B.minmi %>%
  kable(col.names = c("", "q = 0.025", "q = 0.5", "q = 0.975"),
        booktabs=T, format="latex", escape = FALSE) %>%
  add_header_above(c(`Measurement Error Variation`=1, B=3), line=F)

print(B.minmi.kbl)

writeLines(B.minmi.kbl, 
           "../figures/table-sim-exp-minmi-Bs.tex")
```
